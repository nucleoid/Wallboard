...
namespace Wallboard.Tests
{
    public static class ReflectionExtensions
    {
        ...
        public static void SetProperty<T>(this object obj, string propertyName, object value)
        {
            ...
            info.SetValue(obj, value, DefaultFlags, null, null, null);
        }

        public static void SetField<T>(this object obj, string fieldName, object value)
        {
            FieldInfo info = typeof(T).GetField(fieldName, DefaultFlags);

            if (info == null)
                throw new Exception("Property not found");

            info.SetValue(obj, value, DefaultFlags, null, null);
        }
